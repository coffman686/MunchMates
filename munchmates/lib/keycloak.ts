...
export const getAccessTokenClaims = <T>(): T | undefined => keycloak.tokenParsed as T | undefined;

export const getParsedIdToken = <T>(): T | undefined => keycloak.idTokenParsed as T | undefined;
