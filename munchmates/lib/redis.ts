// lib.redis
// Configures and intiializes redis client for backend usage
...
// returns whether redis client is ready for requests
export function isRedisReady() {
  return Boolean(global.__redisReady);
}

// makes sure there is a connection to the redis instance
