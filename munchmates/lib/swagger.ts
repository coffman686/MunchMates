// lib/swagger.ts
// Contains all information to build swagger documentation page
// Documents all API endpoints, inputs, and response formats
// Provides ability to test requests with user provided token
      ...
      paths: {
        ...
        "/api/grocery": {
          ...
          put: {
            ...
            description: "Updates a grocery item's name, quantity, category, or completed status.",
            requestBody: {
              required: true,
              content: {
                "application/json": {
        ...
        "/api/grocery/categories": {
          get: {
            ...
            description: "Returns user's custom grocery categories. Seeds defaults on first call.",
            responses: {
              200: {
        ...
        "/api/spoonacular/recipes/popular": {
          get: {
            ...
            parameters: [{ name: "offset", in: "query", schema: { type: "integer", default: 0 } }],
            responses: {
        ...
        "/api/recipes/info": {
          get: {
            ...
            description:
              "Fetches full recipe details from Spoonacular. Normalizes ingredient names for pantry matching.",
        ...
        "/api/shared-collections/{id}": {
          ...
          put: {
            ...
            description: 'Actions: "update" (name/description), "addRecipe", "removeRecipe".',
            parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }],
            requestBody: {
              required: true,
              content: {
        ...
        "/api/users/search": {
          get: {
            ...
            description:
              "Returns up to 10 matching users. Minimum 2-character query. Excludes the requesting user.",
            parameters: [
              {
                name: "q",
                in: "query",
