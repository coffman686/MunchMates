// lib/nutrition-goals.ts
// Structures output for nutrition information on a given recipe
// for convenient consolidation and analysis on nutrition summaries
...
// scale nutrition information by factor (usually servings)
export function scaleNutrition(totals: MacroTotals, factor: number): MacroTotals {
  return {
...
// combine two macro totals together
...
// calculate information for single calorie or macro metric
