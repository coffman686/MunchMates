...
import { ImagePlus, Star, Utensils, X, ChefHat, Bookmark } from 'lucide-react';
                ...
                <div className="space-y-4 py-2">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={4}
                            maxLength={2000}
                            className="w-full rounded-xl border border-border/50 bg-muted/30 p-3 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-primary/30"
                        />
                    ...
                    <div>
                        ...
                        {imagePreview ? (
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 rounded-xl border border-dashed border-border/60 bg-muted/30 p-6 text-sm text-muted-foreground hover:bg-muted/50 transition"
                            >
