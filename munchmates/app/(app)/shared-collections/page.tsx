...
import { BookOpen, Crown, Edit, Eye, FolderHeart, Plus, Trash2, Users } from "lucide-react";
                ...
                {isLoading ? (
                  ...
                  >
                    ...
                    <p className="text-sm text-muted-foreground max-w-xs mb-6">
                      Create a collection to organize and share your favorite recipes with friends
                      and family.
                    </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {collections.map((collection) => {
                      ...
                      const images = collection.recipes
                        ...
                        .slice(0, 4);
                      const placeholderCount = images.length > 1 ? 4 - images.length : 0;
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="p-3 pb-0">
                            {images.length > 0 ? (
                              <div
                                className={`relative grid gap-1.5 rounded-xl overflow-hidden ${images.length === 1 ? "grid-cols-1" : "grid-cols-2"}`}
                                style={{ background: getGradient(collection.name) }}
                              >
                                {images.map((img) => (
                                  <div key={img} className="relative aspect-[3/2] bg-muted">
                                    <Image
                                ...
                                {images.length > 1 && (
                                  <>
                                    <div className="absolute inset-0 flex items-center justify-center">
                                      <div className="h-full w-[6px] bg-card" />
                                      <div className="absolute w-full h-[6px] bg-card" />
                                    </div>
                                    {placeholderImages.map((i) => (
                                      <div
                                        key={i}
                                        className="relative aspect-[3/2] bg-muted bg-transparent"
                                      />
                                    ))}{" "}
                                  </>
                                )}
                          ...
                          <div className="p-3 pt-2.5">
                            ...
                            <div className="flex items-center justify-between mt-2">
                              <Badge
                                variant="secondary"
                                className="rounded-full text-[10px] px-2 py-0 flex items-center gap-1"
                              >
                                {icon}
                                {label}
                              </Badge>
